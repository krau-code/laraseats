        ...
        <form @submit.prevent="createMovie">
            ...
            <div class="flex flex-col md:flex-row gap-x-3">
                ...
                <div class="mb-4 grow">
                    ...
                    <div class="mt-2">
                        <input id="genre" type="text" v-model="tempGenre" class="w-full border border-gray-300 text-gray-800 focus:outline-none px-3 py-2" @keydown="addGenre" required/>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async createMovie() {
            ...
            await axios.post('/admin/movies/create', data)
            .then(response => {
